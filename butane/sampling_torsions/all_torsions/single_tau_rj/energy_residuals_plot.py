...
butane = ScanSet.parse_psi4_out(scan, structure)
...
with PdfPages('Energy_residuals_single_rj.pdf') as pdf:
    # Update parameters
    for i in range(25):
        db = sqlite_plus.load('all_10000000_{}/all_10000000_{}.sqlite'.format(i, i))
        plt.figure()
        plt.subplot(1, 2, 1)
